...
export const  products: Product[] = [
    {
        id: 1, name: '0.12 CT Baquette Cut Diamond Rose Gold Ring', price: 335,
        imageUrl: [
    ...
    {
        id: 4, name: 'Metis 1.44 Baguette Cut Diamond Ring', price: 620,
        imageUrl: [
    ...
    {
        id: 5, name: 'Aden 0.30 CT Baguette Cut Diamond White Gold Ring', price: 420,
        imageUrl: [
    ...
    {
        id: 6, name: '0.55 CT Multicolor Sapphire and Brown Diamond Ring', price: 175,
        imageUrl: [
    ...
    {
        id: 7, name: 'Flare 0.28 CT Multicolor Sapphire and Daimond Ring', price: 200,
        imageUrl: [
    ...
    {
        id: 8, name: 'Cutie  0.16 CT Daimond and Green Sapphire Dual Heart Ring', price: 230,
        imageUrl: [
    ...
    {
        id: 9, name: 'Eye 0.11 CT Sapphire and Diamond Rose Gold Ring', price: 167,
        imageUrl: [
    ...
    {
        id: 10, name: 'Aten Diamond and Sapphire Rose Gold Ring', price: 285,
        imageUrl: [
    ...
    {
        id: 11, name: '2.38 CT Multicolor Sapphire White Gold Eternity Ring', price: 305,
        imageUrl: [
    ...
    {
        id: 12, name: '2.55 CT Oval Cut Citrine and Diamond Rose Gold Ring', price: 332,
        imageUrl: [
    ...
    {
        id: 13, name: ' Hearts 0.05 CT Diamond White Gold Ring', price: 189,
        imageUrl: [
    ...
    {
        id: 14, name: 'Loop 0.02 CT Diamond Rose Gold Ring', price: 210,
        imageUrl: [
    ...
    {
        id: 15, name: 'Minimal Diamond Chevron Ring', price: 200,
        imageUrl: [
    ...
    {
        id: 16, name: 'Moon 0.09 CT Blue Sapphire and Diamond White Gold Ring', price: 285,
        imageUrl: [
